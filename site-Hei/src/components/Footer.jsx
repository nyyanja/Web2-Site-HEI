      ...
      <div className="w-full bg-[#00194A] text-white">
        <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="text-center lg:text-left">
            <img src={heiLogo} alt="HEI Logo" className="h-24 mx-auto mb-6" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-yellow-500 font-bold hover:text-yellow-500 transition">
                  Accueil
                </a>
              </li>
              <li>
                <a href="#" className="text-white font-bold hover:text-yellow-500 transition">
                  Actualités
                </a>
              </li>
              <li>
          ...
          {/* Colonne 4 - Médias sociaux alignés */}
          <div>
            <h2 className="text-2xl font-bold mb-4">Médias sociaux</h2>
            <div className="flex items-center gap-4">
              <a href="#" className="bg-yellow-500 p-3 rounded-full hover:scale-110 transition">
