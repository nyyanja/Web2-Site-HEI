...
export default function AdmissionSection() {
  return (
    <div 
      className="min-h-screen bg-[#6586C7] flex items-center justify-center p-8 overflow-x-hidden"
    >
      <div className="w-full">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-white mb-8 font-garamond">Admission</h1>
